    ...
    <template x-if="characters.length > 0">
        <div>
            ...
            <div
                ...
                class="fixed inset-0 sm:inset-auto sm:absolute sm:bottom-16 sm:right-0 sm:w-[360px] sm:h-[min(500px,70vh)] bg-zinc-900 sm:border sm:border-zinc-700 sm:rounded-sm shadow-2xl flex flex-col overflow-hidden"
            >
                {{-- Header --}}
            ...
            <button
                @click="toggle()"
                class="w-14 h-14 rounded-full bg-accent text-black shadow-lg hover:brightness-90 transition items-center justify-center"
                :class="open ? 'ring-2 ring-accent/50 hidden sm:flex' : 'flex'"
            >
