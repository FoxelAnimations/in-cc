            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($collabs as $collab)
                        <a href="{{ route('collabs.show', $collab->slug) }}"
                           class="group bg-zinc-900 border border-zinc-800 rounded-sm overflow-hidden transition hover:border-zinc-700">
                            ...
                            <div class="p-5">
                                ...
                                @endif
                                <span class="inline-flex items-center mt-2 text-accent text-sm font-bold uppercase tracking-wider">
                                    {{ __('Bekijken') }}
