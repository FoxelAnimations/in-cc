                ...
                @if ($socialLinks->isNotEmpty())
                    <div class="flex flex-col gap-3 mt-4">
                        @foreach ($socialLinks as $link)
                            <a href="{{ $link->url }}" target="_blank" rel="noopener" class="group flex items-center justify-between bg-accent text-black px-6 py-2 text-xl md:text-2xl font-bold uppercase tracking-wider transition hover:brightness-90">
